...
func (r *AIResponse) ShouldEscalate() bool {
	...
	nonEscalateReasons := map[string]bool{
		"smalltalk_thanks":   true,
		"smalltalk_greeting": true,
	}

	if nonEscalateReasons[r.RefusalReason] {
		return false
	}
...
func (r *AIResponse) PrepareAnswer(escalationVariant int) (string, string) {
	...
	case "answer_verification_failed", "insufficient_context":
